...
} = require("../utils/communication-service");
...
module.exports = (app) => {
	...
	app.put("/wishlist", UserAuth, async (req, res, next) => {
		...
		// get payload for send to customer service
		...
		try {
			PublishCustomerEvent(data); //store using gateway
			console.log("🚀 ~ file: products.js:78 ~ app.put ~ data:", data);
